...
console.log("sdfsfsd----");
d3.json('/static/result.json',function(data){ 
...
// and waiting for the force layout.
  ...
  var node = d3.select('#myChart').selectAll('circle')
    .data(force.nodes())
    .enter().append('circle')
  //we return the exact flag of each country from the image
    .attr('class', function (d) { return 'flag flag-' + d.attribute; })
